...
// ************************************************************************************************************
// I2C Compass HMC6352 my compass
// ************************************************************************************************************
// I2C adress: 0x3C (8bit)   0x1E (7bit)
// ************************************************************************************************************
#if defined(HMC6352)
#define MAG_ADDRESS 0x42>>1
#define MAG_DATA_REGISTER 0x03
...
//  Wire.beginTransmission(MAG_ADDRESS); 
  Wire.requestFrom(MAG_ADDRESS, 2);    // request 2 bytes from device
  ...
  if (i == 2) {
    ...
    MAG_Heading = (buff[0] * 256 + buff[1])/10.0;
    MAG_Heading = MAG_Heading * 0.01745329252;  //to rad
  } else {
    // Serial.println("!ERR: Mag data");
  }
    
  MAG_ORIENTATION(sin(MAG_Heading) * 100, cos(MAG_Heading) * 100, 1);
}
